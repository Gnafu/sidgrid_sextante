...
public class PolygonToEvapotraAlgorithm extends GeoAlgorithm{
	...
	public void defineCharacteristics() {
		setName(Sextante.getText("Polygon to Evatraspiration"));
		...
		try {
			...
			addOutputVectorLayer(RESULT, Sextante.getText("Evatraspiration zone"), OutputVectorLayer.SHAPE_TYPE_POLYGON);
	...
	public boolean processAlgorithm() throws GeoAlgorithmExecutionException {
		...
		final Class[] outputFieldTypes = new Class[2 + (dStressPeriod*3)];
	    final String[] outputFieldNames = new String[2 + (dStressPeriod*3)];
	    String riga = "row";
	    String colonna = "col";
	    String nome = "evatraspira";
	    ...
	    {
	    	outputFieldNames[rec] =  "sp_"+(n) + "_surf";
	    	outputFieldNames[rec+1] =  "sp_"+(n)+ "_evtr";
	    	outputFieldNames[rec+2] =  "sp_"+(n)+ "_exdp";
	    	n++;
	    	rec = rec + 3;
	    }
	    ...
	    while (iterator.hasNext() && setProgress(i, iTopCount)){
			...
			final Object[] resultValues = new Object[2 + (dStressPeriod*3)];
