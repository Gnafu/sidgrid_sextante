 ...
 * Rudy Rossetto
 */
public class DrainFileAlgorithm extends GeoAlgorithm{

	public static final String LAYER  = "LAYER";
	public static final String DRAIN = "DRAIN";	
	public static final String SP = "SP";
	public static final String IDRNCB = "IDRNCB";
	public static final String COUNT  = "COUNT";
	@Override
	public void defineCharacteristics() {
		this.setName(Sextante.getText("Drain file wrapper"));
		...
		try {
			...
			m_Parameters.addFilepath(DRAIN, Sextante.getText("Drain"), false, false, ".drn");
			m_Parameters.addNumericalValue(IDRNCB, Sextante.getText("Cell balance unit number"),
	...
	public boolean processAlgorithm() throws GeoAlgorithmExecutionException {
		...
		String sFilename = m_Parameters.getParameterValueAsString(DRAIN);
		...
		int irivcb = m_Parameters.getParameterValueAsInt(IDRNCB);	//numero dell'unitˆ in cui scrivere bilancio cella cella
		...
		if (sFilename != null){
			...
			try {
				...
				/*-----------DATA SET 0---------------*/
				out.println("# Drn Package "+"created on "+todayDay+"/"+todayMonth+"/"+todayYear);
			    ...
			    for (int c = 0, i = iniziale; c < stressCount && i < finale; i = iniziale + incremento, c++){
					...
					{							
						 ...
						 Double elevaValue = (Double) recordGeo.getValue(i);
						 Double condValue = (Double) recordGeo.getValue(i+1);
						 
						 Double xyzValue = (Double) recordGeo.getValue(i+2);
						 
						 String dataSetTreB = String.format("   %3s   %3s   %3s   %3s   %3s   %3s",layerValueIntero, roValue,colValue, elevaValue, condValue, xyzValue );
